...
int game_one_player(int num2)
{
    ...
    Font font2;
    if (font2.loadFromFile("Evogria.otf") == false)
    {
        return -1;
    }
    Text score1;
    ...
    score1.setFillColor(Color::Blue);
    score1.setPosition(400, 350);
    //End time of play
    ...
    ball.setPosition(300.0f, 346.0f);
    ...
    while (window.isOpen())
    {
        ...
        */
        if (ball.getPosition().y>320 && ball.getPosition().x > 450) {
            player2.move(0.0f, 9.0f);
        ...
        while (time >= update)
        {
            ...
            if (new_pos.x - ball_redius < 88 && ball.getPosition().y < 177) {

                direction.x *= -1;
                new_pos.x = 88 + ball_redius;
            }

            else if (new_pos.x - ball_redius < 88 && ball.getPosition().y > 535)
           {
            ...
            else if (new_pos.x + ball_redius >= 940 && ball.getPosition().y < 177) {
                direction.x *= -1;
                new_pos.x = 940 - ball_redius;

            }
            else if (new_pos.x + ball_redius >= 940 && ball.getPosition().y > 500) {
                direction.x *= -1;
                new_pos.x = 940 - ball_redius;
        ...
        //score increasing
        std::stringstream textscore, text1;
        if (scorep2 == 4)
        {
            text1 << "computer is win ..";
        }
        else if (scorep1 == 4)
        {
            text1 << "player 1 is win ..";
        }
        score1.setString(text1.str());
...
void help()
{
    RenderWindow window(VideoMode(640, 747), "Help");
    Texture texture;
    Sprite sprite;
    texture.loadFromFile("help1.jpg");
    sprite.setTexture(texture);
    sprite.scale(Vector2f(0.7f, 0.8f));
...
int main()
{
    ...
    menuphoto.setPosition(0.0, 0.0f);
     ...
     sf::SoundBuffer pong_game;
        pong_game.loadFromFile("beliver.wav");
        Sound sound;
        sound.setBuffer(pong_game);
        sound.play();
